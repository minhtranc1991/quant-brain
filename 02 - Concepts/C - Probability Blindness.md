...
- **Enrichment — a third, well-studied manifestation ([[The Art of Statistics - Learning From Data]]):** where the above documents superstitious-ritual formation and loss-averse emotional asymmetry as manifestations of probability blindness, Spiegelhalter documents a third, mechanistically distinct and extensively replicated manifestation: systematic confusion of two different conditional probabilities, popularly known as the **prosecutor's fallacy**. People (including trained professionals and, in a documented 2012 survey, a majority of UK Members of Parliament asked a basic coin-flip probability question) routinely confuse P(evidence | hypothesis) with P(hypothesis | evidence) — e.g. treating "90% of cancer patients test positive" as if it meant "90% of positive tests indicate cancer." When the underlying condition is rare, these two probabilities can differ enormously: in a documented mammography example with 1% true cancer prevalence and a "90% accurate" test, only 8% of positive results are actually cancer, because the large healthy population still generates many false positives even at a low per-person false-positive rate. Unlike the ritual-formation and loss-aversion manifestations, this failure has a documented, reliable debiasing technique: reframing the calculation as an "expected frequency tree" over a hypothetical population (e.g. "out of 1,000 people...") rather than as abstract percentages measurably improves correct reasoning, including among people who get the equivalent abstract-probability question wrong.

- **Enrichment — a fifth manifestation, the availability heuristic and affect heuristic ([[Thinking, Fast and Slow]]):** Kahneman documents two further, mechanistically distinct manifestations of probability blindness. (1) The **availability heuristic** — judging an event's frequency or probability by how easily instances come to mind, rather than by its actual base rate — is distorted by factors unrelated to true frequency (vividness, recency, personal involvement, media coverage), producing systematic over- or under-estimation of category frequencies (e.g. dramatic causes of death are recalled more easily, and judged more frequent, than statistically far more common but less memorable ones). (2) The **affect heuristic** (originally Paul Slovic's term) — judging a risk mainly by the immediate emotional reaction it evokes rather than by an evidence-based estimate — combines with media-driven "availability cascades" (a self-reinforcing cycle in which public attention and expert/political response amplify each other) to produce collective risk perceptions that diverge sharply and durably from the underlying statistical risk. Source: [[Thinking, Fast and Slow]], Chapters 12-13.
...
- **Enrichment — the availability heuristic in practice ([[Thinking, Fast and Slow]]):** in controlled experiments, subjects asked to recall six instances of their own assertive behavior rated themselves *less* assertive than subjects asked to recall only twelve instances — because the difficulty of generating twelve instances was itself misread as evidence of low assertiveness, showing that the *ease* of retrieval, not merely the *content* retrieved, drives the availability-based judgment. Source: [[Thinking, Fast and Slow]], Chapter 12.
- **Enrichment — a fourth, structurally distinct manifestation: mistaking the unfamiliar for the improbable ([[The Signal and the Noise]]):** before the Pearl Harbor attack, U.S. military planners implicitly reasoned via a flawed syllogism ("The United States is rarely attacked; Hawaii is part of the United States; therefore Hawaii is unlikely to be attacked") that ignored Hawaii's genuinely distinct risk profile. Economist Thomas Schelling's sharper diagnosis (quoted in the source) is that the failure runs deeper than flawed reasoning: "there is a tendency in our planning to confuse the unfamiliar with the improbable" — a contingency that has not been seriously considered is not merely judged unlikely, it is frequently not consciously considered as a possibility at all (Donald Rumsfeld's "unknown unknowns"). This is mechanistically distinct from the ritual-formation, loss-aversion, and prosecutor's-fallacy manifestations already documented above: those describe *miscalculating* a probability that was considered; this one describes a contingency never entering conscious probability judgment in the first place, producing a structural blind spot rather than a correctable numeric error. Source: [[The Signal and the Noise]], Chapter 13 ("The Unfamiliar and the Improbable").
